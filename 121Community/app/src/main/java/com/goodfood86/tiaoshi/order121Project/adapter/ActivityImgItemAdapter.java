 ...
 */
public class ActivityImgItemAdapter extends BaseAdapter {
    private Context context;
    private LayoutInflater layoutInflater;
    private List<GridViewModel> nodesBeanT;

    public ActivityImgItemAdapter(Context context, List<GridViewModel> nodesBeanT) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View view = layoutInflater.inflate(R.layout.item_activity_img_gridview, null);
