 ...
 */
public class JiazhengGridviewAdapter extends BaseAdapter {
    private Context context;
    private LayoutInflater layoutInflater;
    private List<ModuleMainModel.DataBean.NodesBean.NodesBeanT> nodesBeanT;

    public JiazhengGridviewAdapter(Context context, List<ModuleMainModel.DataBean.NodesBean.NodesBeanT> nodesBeanT) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
       ...
       View view= layoutInflater.inflate(R.layout.jiazheng_item,null);
