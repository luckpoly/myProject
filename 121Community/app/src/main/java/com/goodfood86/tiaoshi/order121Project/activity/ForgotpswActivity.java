 ...
 */
public class ForgotpswActivity extends Activity implements View.OnClickListener {
        ...
        switch (v.getId()) {
            case R.id.iv_register_yanzhengma:
                if (user.equals("") || user == null) {
                    ToastUtil.showShort(ForgotpswActivity.this, " 手机号不能为空");
                    break;
                ...
                httpUtils.send(HttpRequest.HttpMethod.POST, G.Host.GET_YANZHENGMA, getyanzhengma, new MyRequestCallBack(ForgotpswActivity.this, handler, 1, new VerifyModel()));
                new Countdown().start();
                setbg();
                break;
            case R.id.tv_register_register:
                if (user.equals("") || user == null) {
                    ...
                    ToastUtil.showShort(this, "两次输入密码不相同");
                    break;
            }
                dialog.show();
...
//                regsiterhttp.addBodyParameter("confirm", ispsw);
//				regsiterhttp.addBodyParameter("inviteCode","");

                httpUtils.send(HttpRequest.HttpMethod.POST, G.Host.RESTPASSWORD, regsiterhttp, new MyRequestCallBack(ForgotpswActivity.this, handler, 2, new VerifyModel()));
                break;
            ...
            switch (msg.what){
                case 1:
                    ...
                    if (verifyModel.getRespCode()==0){
                        ToastUtil.showShort(ForgotpswActivity.this,verifyModel.getRespMsg());
                ...
                case 2:
                    ...
                    if (verifyModel1.getRespCode()==0){
                        ToastUtil.showShort(ForgotpswActivity.this, verifyModel1.getRespMsg());
