 ...
 */
public class kuaixiuDownGridviewAdapter extends BaseAdapter {
    private Context context;
    private LayoutInflater layoutInflater;
    private List<ModuleMainModel.DataBean.NodesBean> nodesBeanT;

    public kuaixiuDownGridviewAdapter(Context context, List<ModuleMainModel.DataBean.NodesBean> nodesBeanT) {
        this.context = context;
        this.nodesBeanT = nodesBeanT.subList(2,nodesBeanT.size());
