 ...
 */
public class StoreProductJuiceAdapter extends BaseAdapter {
    ...
    public StoreProductJuiceAdapter(final Context context, List<StoreProductJsonData.DataBean.ListBean> mDataset, final Handler handler, String shop_id, BadgeView badgeView) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(context).inflate(R.layout.juice_list_item, null);
        ...
        bitmapUtils.display(viewHolder.img, listEntity.getIcon());
        viewHolder.title.setText(listEntity.getGoodsName());
        if (null!=listEntity.getTags()&&listEntity.getTags().size()>0){
            viewHolder.tv_tag.setText(listEntity.getTags().get(0));
        }
        viewHolder.store_product_tvUnit.setText("元/" + listEntity.getSalesUnit());
            ...
            viewHolder.store_product_tvSaleCount.setText(listEntity.getGoodsTitle());
    ...
    public class ViewHolder {
        ...
        public TextView price,  tv_pack_choose,tv_tag;
        ...
        private LinearLayout store_product_llTag;
        private ImageView store_product_ivGift;
        private ImageView store_product_ivChaoZhi;
        private ImageView store_product_ivChaoZhi2;
    }
    /**
     * @Description: 创建动画层
     * @param
    ...
    private ViewGroup createAnimLayout() {
        ViewGroup rootView = (ViewGroup)((StoreDetailActivity)context).getWindow().getDecorView();
