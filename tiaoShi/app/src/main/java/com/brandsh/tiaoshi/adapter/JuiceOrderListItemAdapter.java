 ...
 */
public class JuiceOrderListItemAdapter extends BaseAdapter {
    ...
    public JuiceOrderListItemAdapter(List<JuiceOrderListdata.DataBean.OrderGoodsBean> resList, Context context) {
