 ...
 */
public class JuiceOrderListAdapter extends BaseAdapter {
    ...
    public JuiceOrderListAdapter(List<OrderListJsondata1.DataBean.ListBean> resList, Context context, Handler hander) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            viewHolder.tv_chongxinfx = (TextView) convertView.findViewById(R.id.tv_chongxinfx);
        ...
        viewHolder.tv_chongxinfx.setVisibility(View.GONE);
        ...
        switch (OrderStatusUtil.getOrderStatus(listEntity.getStatus(),listEntity.getDeliveryStatus(),listEntity.getRefundStatus(),listEntity.getCancelStatus(),listEntity.getEvaluateStatus())){
            ...
            case "待配送":
                ...
                viewHolder.tv_ordercancel.setVisibility(View.GONE);
                if (listEntity.getShareStatus().equals("UNSHARE")){
                    viewHolder.tv_fenxiang.setVisibility(View.VISIBLE);
                    viewHolder.tv_dailingqu.setVisibility(View.GONE);
                    viewHolder.tv_yilingqu.setVisibility(View.GONE);
                }else if (listEntity.getShareStatus().equals("STAY")){
                    viewHolder.tv_fenxiang.setVisibility(View.VISIBLE);
                    viewHolder.tv_dailingqu.setVisibility(View.VISIBLE);
                    viewHolder.tv_yilingqu.setVisibility(View.GONE);
                }else if (listEntity.getShareStatus().equals("FAILURE")){
                    viewHolder.tv_chongxinfx.setVisibility(View.VISIBLE);
                    viewHolder.tv_dailingqu.setVisibility(View.GONE);
                    viewHolder.tv_yilingqu.setVisibility(View.GONE);
                }else {
                    viewHolder.tv_fenxiang.setVisibility(View.GONE);
        ...
        viewHolder.tv_chongxinfx.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                context.startActivity(new Intent(context, FenxiangActivity.class).putExtra("id",listEntity.getOrderId()+""));
            }
    ...
    private class ViewHolder {
        ...
        ,tv_fenxiang,tv_dailingqu,tv_chongxinfx;
    }
